...
Vue.component('notification', __webpack_require__(36));

Vue.component('update-status', __webpack_require__(44));
...
var update = __webpack_require__(40)("4ca9f156", content, false, {});
...
Component.options.__file = "resources/assets/js/components/UpdateStatus.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6f91f35c", Component.options)
  } else {
    hotAPI.reload("data-v-6f91f35c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
  ...
  methods: {
    updateStatus: function updateStatus(event) {
      ...
      axios.patch(this.endPoint, {
        ...
        flash(data);
        _this.oldValue = _this.selected;
      }).catch(function (_ref2) {
        var data = _ref2.data;

        console.log(data);
        flash("Something wrong, Please try again later.", "danger");
        _this.selected = _this.oldValue;
      });
    }
  }
});
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6f91f35c", module.exports)
  }
}
